...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-white to-green-100 text-gray-800 font-sans">
      {/* Header */}
      <header className="bg-green-700 text-white py-4 shadow mb-2 z-10 relative">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <button
            onClick={handleLogin}
            className="px-5 py-2 bg-white text-green-700 rounded-full font-semibold shadow hover:bg-green-100 transition"
          >
            Masuk
          </button>
        </div>
      ...
      <section className="flex flex-col md:flex-row items-center max-w-7xl mx-auto px-6 py-20 gap-10">
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-5xl md:text-6xl font-extrabold mb-6 text-green-700 leading-tight">
          ...
          <button
            onClick={handleLogin}
            className="inline-flex items-center gap-3 px-7 py-4 bg-green-600 text-white text-lg rounded-full shadow-lg hover:bg-green-700 transition-all duration-300"
          >
            Masuk ke Home
            <svg
      ...
      <section className="bg-white py-20 border-t border-green-100">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h3 className="text-4xl font-bold text-green-700 mb-10">Layanan Kami</h3>
      ...
      <section className="bg-green-50 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h3 className="text-4xl font-bold text-green-700 mb-10">Apa Kata Mereka?</h3>
          <div className="space-y-8">
            <blockquote className="bg-white p-6 rounded-xl shadow">
              ...
              <footer className="mt-3 font-semibold text-green-800">— Andi, pemilik kucing</footer>
            </blockquote>
            <blockquote className="bg-white p-6 rounded-xl shadow">
              <p className="italic text-gray-700">"Tempatnya bersih dan nyaman, hewan saya senang dirawat di sini."</p>
              <footer className="mt-3 font-semibold text-green-800">— Siska, pemilik anjing</footer>
            </blockquote>
          </div>
        </div>
      </section>
